 ...
 * 行业分类模块的错误信息处理类
 */
public class BoardErrInfo implements ErrorInformation {
	...
	public static final int NEEDED_FIELD_NOT_NULL=7; //请填写所有的必填项
	...
	private void initErrTable(){
		...
		errTable.put(new Integer(NEEDED_FIELD_NOT_NULL),"留言内容不能为空");
