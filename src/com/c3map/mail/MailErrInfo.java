...
public class MailErrInfo implements ErrorInformation {
	...
	public static final int NEEDED_FIELD_NOT_NULL=7; //邮件的主题和内容不能为空
	public static final int GENERATE_KEY_FAILED=8; //内部错误，主键生成失败
	...
	private void initErrTable(){
		...
		errTable.put(new Integer(NEEDED_FIELD_NOT_NULL),"邮件的主题和内容不能为空");
